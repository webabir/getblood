	...
	<div class="form-section text-center">
		<form method="post" action="<?php echo base_url() ?>admin-login">
			...
			<div class="form-group password mb-3">
				...
				<a id="iconBtn" onclick="showHide()" data-toggle="0" href="javascript:;"><i id="showHideIcon" class="fas fa-eye-slash"></i></a>
			</div>
...
<script>
	function showHide() {
		...
		if (iconBtn.dataset.toggle == "0") {
			iconBtn.dataset.toggle = "1";
			icon.classList.add('fa-eye');
			icon.classList.remove('fa-eye-slash');
			InputPassword.type = "text";
		} else {
			iconBtn.dataset.toggle = "0";
